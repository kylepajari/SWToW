...
public class level3OutroScript : MonoBehaviour {
    ...
    void Start()
    {
        ...
        follower = GameObject.Find("XWingAlly");
    ...
    public IEnumerator outrosequence()
    {
        ...
        if (num == 5)
        {
            ...
            StartCoroutine(MoveOverTime(follower.transform, (follower.transform.forward * 240), 32));
        ...
        if (num == 1)
        {
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(RotateOverTime(follower.transform, Quaternion.Euler(0, 180, 180), 1f));
            yield return new WaitForSeconds(1f);
            StartCoroutine(RotateOverTime(follower.transform, Quaternion.Euler(0, 180, 1), 1f));
