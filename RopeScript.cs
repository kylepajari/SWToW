...
public class RopeScript : MonoBehaviour
{
  ...
  void LateUpdate()
  {
    ...
    //check if player has died, if so destroy rope
    PlayerControls playerScript = GameObject.Find("SPlayer").GetComponent<PlayerControls>();
    if (playerScript.died && rope)
    {
      DestroyRope();
    }
  }
